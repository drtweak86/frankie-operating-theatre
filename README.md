<p align="center">
  <img src="frankie.png" width="300" alt="Frankie">
</p>
...
- **Recovery/Dev Tools** – Robust dev environment & recovery utilities (`pi-dev-recovery.sh`)  
- **Backup & Restore** – Archive & restore `/home/pi` safely (`pi-backup.sh`, `pi-restore.sh`)  
- **GitHub SSH Setup** – One-shot script for SSH key + Git config (`setup-ssh-github.sh`)  

### 🚀 Quick Start
```bash
# One-liner to bootstrap your workstation
